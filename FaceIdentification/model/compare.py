...
import numpy as np
import cv2
from FaceIdentification.model import facenet


def face_detection(img, img_size):
    # 读入一张图片
...
def cmp(img1, img2):
    ...
    # image1
    image1_p = face_detection(img1, image_size)
    ...
    # image2
    image2_p = face_detection(img2, image_size)
...
if __name__ == '__main__':
    ...
    image_name1 = "zhang_test.png"
    image_name2 = "zhang_train.jpg"
    img1 = cv2.imread(r"E:\Works\Project\Students_and_Certificates_Comparison\zhang_train.jpg")
    img2 = cv2.imread(r"E:\Works\Project\Students_and_Certificates_Comparison\zhang_test.png")
    dist = cmp(img1, img2)
    print(dist)